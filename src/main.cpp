...
int main()
{
    ...
    */
    ...
    sf::Music backSounds;
    backSounds.openFromFile("res/sounds/backSounds.ogg");
    ...
    world.load3DObj("res/maps/city_big.obj", WALL_TEXTURE, 0.03, {-1, 1});
    ...
    server.loadObjSpawns("res/maps/spawns_city_big.obj", 0.03);
...
//
    ...
    while (window.isOpen())
    {
        ...
        // Title update
        std::string title = "Pseudo3DEngine " + std::to_string((int)1 / d_elapsedTime) + "fps.";
        if (camera != nullptr)
